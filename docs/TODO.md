...
- [x] `P0-M8-01` Implement terminal/desktop notification dan sound best-effort; Windows Runtime toast, async dispatch, terminal/sound fallback, dan failure isolation tervalidasi.
